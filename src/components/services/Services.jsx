        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
          <div class="lg:text-center">
            ...
            <p class="mt-4 p-6 mx-auto w-8/12 text-center text-xl text-black ">
              Apart from innovative products, we also offer investment service
              and consulting. Thanks to the experience gained in the
              international environment, we can propose a wide range of
              cooperation:
            </p>
          </div>
            ...
            <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              ...
              <div class="relative">
                <dt>
                  ...
                  <p class="ml-16 text-lg leading-6 font-medium text-gray-900">
                    Mentorship during and before starting a building investment
                  </p>
                </dt>
                <dd class="mt-2 ml-16 text-base text-black">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit.
              ...
              <div class="relative">
                <dt>
                  ...
                  <p class="ml-16 text-lg leading-6 font-medium text-gray-900">
                    Planning of the international investment processes
                  </p>
                </dt>
                <dd class="mt-2 ml-16 text-base text-black">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit.
