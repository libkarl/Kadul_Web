...
import brochure from "../../assets/oryx_katalog.pdf";
  ...
  return (
    <>
      <div className="mx-auto text-center p-6 w-11/12 container">
        <h1 className="gallery_header  text-blue-900">{t("gallery.title")}</h1>
      </div>
      ...
      <div className="mx-auto text-center p-6 w-11/12 flex-1 flex-row container mb-14">
        <h1 className="p-6 text-3xl text-blue-900">
