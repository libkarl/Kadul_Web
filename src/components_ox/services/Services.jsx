...
const Services = () => {
  ...
  return (
    <div class="bg-white mb-14 2xl:mt-28" id="possibilities">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
        <div class="lg:text-center">
          <h2 class="text-3xl text-blue-900 font-semibold tracking-wide text-center">
            {t("services.title")}
          </h2>
        ...
        <div class="mt-10 w-10/12 mx-auto">
          <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
            <div class="relative">
              <dt>
                <div class="absolute flex items-center justify-center h-12 w-12 rounded-md bg-sky-600  text-white">
                  <svg
                    class="h-6 w-6"
                    width="24"
                    height="24"
                ...
                <p class="ml-16 text-lg leading-6 font-medium text-gray-900">
                  {t("services.passiveHouse.title")}
                </p>
              </dt>
              <dd class="mt-2 ml-16 text-base text-black">
                {t("services.passiveHouse.text")}
              </dd>
            </div>

            <div class="relative">
              <dt>
                <div class="absolute flex items-center justify-center fill-current  bg-sky-600  text-white h-12 w-12 rounded-xl">
                  <svg
                    class="h-6 w-6 "
                ...
                <p class="ml-16 text-lg leading-6 font-medium text-gray-900">
                  {t("services.performanceRatio.title")}
                </p>
              </dt>
              <dd class="mt-2 ml-16 text-base text-black">
                {t("services.performanceRatio.text")}
              </dd>
            </div>
            ...
            <div class="relative">
              <dt>
                ...
                <p class="ml-16 text-lg leading-6 font-medium text-gray-900">
                  {t("services.fastBuild.title")}
                </p>
              </dt>
              <dd class="mt-2 ml-16 text-base text-black">
                {t("services.fastBuild.text")}
              </dd>
            </div>
            ...
            <div class="relative">
              <dt>
                ...
                <p class="ml-16 text-lg leading-6 font-medium text-gray-900">
                  {t("services.heatingSystem.title")}
                </p>
              </dt>
              <dd class="mt-2 ml-16 text-base text-black">
                {t("services.heatingSystem.text")}
              </dd>
            </div>
            ...
            <div class="relative">
              <dt>
                ...
                <p class="ml-16 text-lg leading-6 font-medium text-gray-900">
                  {t("services.investMentorship.title")}
                </p>
              </dt>
              <dd class="mt-2 ml-16 text-base text-black">
                {t("services.investMentorship.text")}
              </dd>
            </div>
            ...
            <div class="relative">
              <dt>
                ...
                <p class="ml-16 text-lg leading-6 font-medium text-gray-900">
                  {t("services.internationalInvest.title")}
                </p>
              </dt>
              <dd class="mt-2 ml-16 text-base text-black">
                {t("services.internationalInvest.text")}
              </dd>
            </div>
          </dl>
        </div>
